...
function manzili_fragrance_slider() {
    $slides = [
        ...
        [
            ...
            'bottle'      => 'https://www.collectionloriginal.com/wp-content/uploads/2026/07/powerbakkara.png',
            'bottle_blend'=> false,
            'label'       => 'Collection Power',
            'title'       => 'Power',
            'title_size'  => '',
            'watermark'   => 'Bakkara',
            'desc'        => "Des fragrances à l'intensité captivante, aux accords oud et boisés précieux. Une collection pour ceux qui osent affirmer leur caractère avec puissance et élégance.",
            'notes'       => 'Safran · Jasmin · Ambre Gris · Cèdre',
            'link'        => 'https://www.collectionloriginal.com/product-category/collection-power/',
            'link_label'  => 'Voir la collection',
            'link2'       => '',
            'link2_label' => '',
            'has_bg_title'=> false,
